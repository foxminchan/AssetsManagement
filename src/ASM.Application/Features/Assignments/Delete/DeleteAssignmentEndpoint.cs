...
public sealed class DeleteAssignmentEndpoint(ISender sender) : IEndpoint<NoContent, DeleteAssignmentRequest>
{
    public void MapEndpoint(IEndpointRouteBuilder app) =>
        app.MapDelete("/assignments/{id:guid}",
                async (Guid id) => await HandleAsync(new(id)))
    ...
    public async Task<NoContent> HandleAsync(DeleteAssignmentRequest request,
