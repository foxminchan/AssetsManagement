...
public sealed class UpdateAssignmentStateHandlerTest
{
    ...
    [Fact]
    public async Task GivenAdminRequest_ShouldReturnSuccess_WhenUpdateState()
    {
        // Arrange
        var command = new UpdateAssignmentStateCommand(Guid.NewGuid(), State.Accepted);
    ...
    [Fact]
    public async Task GivenUserRequest_ShouldReturnSuccess_WhenUpdateState()
    {
        // Arrange
        var command = new UpdateAssignmentStateCommand(Guid.NewGuid(), State.Accepted);
        var assignment = new Assignment { Id = command.Id };
